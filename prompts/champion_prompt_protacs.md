# Goal
You will be given a paper about PROTACs. The paper is delimited by triple backticks (``` ... ```). Your goal is to extract measurements of PROTAC degradation assays, specifically focusing on DC50 and Dmax assay values. 

# Required Fields

Extract the following 13 fields:

- Compound_Name: Name of the PROTAC compound.
